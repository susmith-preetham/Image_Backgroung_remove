...
# Example usage
target = r"D:\D_drive\BG_remove_new\Tag_add\TAHAMA SPCC 1 OUTPUT\\"
names_list2 = os.listdir(r"D:\D_drive\BG_remove_new\Tag_add\TAHAMA SPCC 1 OUTPUT")
for path_name in tqdm(names_list2):
    image_path = target+path_name
    empty_space_coords = find_empty_space(image_path)
    # print(empty_space_coords)
    x = empty_space_coords[0] # //added
    y = empty_space_coords[1] # //added
